...
// Static geometries for the geometric shape presets. "selfie" is built at
// runtime from user-uploaded edge data, so it's excluded here.
type StaticShape = Exclude<Shape, "selfie">;

export const baseGeometries: Record<StaticShape, THREE.BufferGeometry> = {
...
export const edgesByShape: Record<StaticShape, THREE.EdgesGeometry> = {
